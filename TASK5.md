...
| **E5-8** | File/line → Git Note → checkpoint/trace/session → intention | T5.8 | 🟢 ✅ | 🟡 ◐ | Live corpus persists exact GitAI ranges and an honest missing-attribution case. Customer-visible reverse traversal through the API/UI remains. | `11a4025`, `a954e08`; CI `35489454491` | Provenance audit |
