...
| **T5.10** | Continuous Verification | Continuously verify taxonomy, privacy, collector mapping, graph behavior, semantic quality and Task2/Task4 regressions. | 🟡 ◐ | 🟡 ◐ | Live provider, product and security acceptance required. | T5.1–T5.9 | **Wave 7 · 9** | Fresh pgvector migrations, schema, corpus, provider, graph, security, retention, analytics and semantic gates plus 123 API/security/metric tests, API/web compilation and the production web build pass in CI. GitAI full-suite regression, browser acceptance and E5-12 remain. Customer certification stays in Tasks12/14. |
