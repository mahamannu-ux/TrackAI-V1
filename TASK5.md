...
| **E5-3** | Consent, tenant isolation, encryption, secret redaction and raw authorization | T5.2 | 🟢 ✅ | 🟡 ◐ | Live CI proves explicit consent, envelope encryption, pre-storage secret redaction, raw-read auditing, two tenant scopes and cross-tenant semantic-FK rejection. Role-authorized raw reveal, `no-store` response and log inspection remain. | `44de334`, `2a3e528`, `3df7341`; CI `35489833224` | Security acceptance |
