...
| **E5-3** | Consent, tenant isolation, encryption, secret redaction and raw authorization | T5.2 | 🟢 ✅ | 🟡 ◐ | Live corpus proves explicit consent, envelope-encrypted content, two tenant scopes and cross-tenant semantic-FK rejection. End-to-end redaction, role-authorized raw reveal and audit/log inspection remain. | `44de334`, `2a3e528`, `a954e08`; CI `35489454491` | Security acceptance |
