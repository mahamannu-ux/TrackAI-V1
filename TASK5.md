...
| **E5-2** | One commit with multiple sessions, traces and checkpoints | T5.1, T5.5 | 🟢 ✅ | 🟡 ◐ | Live corpus proves the many-to-many identities and distinct traces/checkpoints. API pagination and customer-visible edge-basis review remain. | `a954e08`; CI `35489454491` | Provenance review |
